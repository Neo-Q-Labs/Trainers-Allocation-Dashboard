...
/* ============================================================
   ...
   ============================================================ */
const PANEL_META = {
  'overview':     { crumb: 'Swift Ops / Planning / Dashboard',         title: 'Trainer Allocation Dashboard',   icon: '<svg viewBox="0 0 24 24" fill="none" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>' },
...
/* ============================================================
   Calendar — Month / Quarter / Year views (Migrated to React)
   ============================================================ */
// Note: Legacy buildCalendar block removed in favor of the React Calendar component.
...
document.addEventListener('click', (e) => {
  ...
  // "New Requirement" is now handled by the React <NewRequirementSimulator />
  // modal mounted in App.jsx — the legacy event delegate here used to open a
  // throwaway placeholder modal. Removed to avoid the two firing in parallel.
